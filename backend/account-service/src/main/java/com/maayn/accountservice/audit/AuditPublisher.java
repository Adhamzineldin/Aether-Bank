...
/**
 * Lightweight audit-event publisher for account-service. See
 * {@code com.maayn.cardservice.audit.AuditPublisher} for the full rationale —
 * same shape, decoupled from any generated SDK so it works even though
 * account-service doesn't ship the audit veld client.
 */
@Component
