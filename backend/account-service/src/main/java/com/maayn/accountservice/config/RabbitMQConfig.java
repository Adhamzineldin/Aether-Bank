...
public class RabbitMQConfig {
    ...
    /**
     * Shared banking topic exchange. Must match {@code banking.exchange} used by
     * transaction-service / notification-service (see
     * {@code maayn.veld.generated.constants.TransactionRabbitConfig#BANKING_EXCHANGE}).
     */
