...
@Component("loanInterestOnlyStrategy")
public class InterestOnlyLoanInterestStrategy implements LoanInterestStrategy {
    @Override
    public InterestDetail calculate(BigDecimal principal, BigDecimal annualRate, LocalDate from, LocalDate to, List<RateChange> rateHistory) {
        ...
        return new InterestDetail(from, to, days, rate, FinancialMath.money(principal), interest, false, "Interest-only accrual");
    }
}
