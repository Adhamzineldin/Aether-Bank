...
class LedgerBalanceTest {
    ...
    class ConstructorTests {
        ...
        @Test
        @DisplayName("Should initialize with given accountId")
        void constructor_setsAccountId() {
            UUID id = UUID.randomUUID();
            LedgerBalance balance = new LedgerBalance(id);
            assertThat(balance.getAccountId()).isEqualTo(id);
        }

        @Test
        @DisplayName("Should initialize available balance to zero")
        void constructor_zeroAvailableBalance() {
            LedgerBalance balance = new LedgerBalance(UUID.randomUUID());
    ...
    class DebitTests {
        ...
        @Test
        @DisplayName("Should throw TransferException when amount exceeds balance")
